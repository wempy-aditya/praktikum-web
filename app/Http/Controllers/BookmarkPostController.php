...
class BookmarkPostController extends Controller
{
    ...
    {
        // Ambil bookmarked_posts, jika null set menjadi array kosong
        $bookmarked_post_ids = request()->user()->bookmarked_posts ?? [];

        // Ambil posts yang dibookmark
        $posts = $bookmarked_post_ids ? Post::whereIn('id', $bookmarked_post_ids)->get() : collect();
