    ...
    <section class="px-6 py-8">
        <nav class="md:items-center mb-6 flex justify-between">
            ...
            <div class="md:mt-0 flex items-center">
                ...
                @else
                <a href="/register" class="text-xs text-black font-bold uppercase">Sign Up</a>
                <a href="/login" class="ml-6 text-xs text-black font-bold uppercase">Sign In</a>
                @endauth
                    ...
                    <form action="/newsletter" method="POST" class="lg:flex text-sm">
                        ...
                        <div class="lg:py-3 lg:px-5 flex items-center">
                            <label for="email" class="hidden lg:tw-inline-block">
                                <img src="/images/mailbox-icon.png" alt="mail icon">
                            </label>
